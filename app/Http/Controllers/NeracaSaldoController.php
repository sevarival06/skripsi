...
class NeracaSaldoController extends Controller
{
    ...
    // Detail Neraca Saldo (neraca_saldo.blade.php)
    public function detail(Request $request)
    {
        ...
        if (empty($bulan) || empty($tahun)) {
            return redirect()->route('neraca.saldo')->with('error', 'Bulan dan tahun harus diisi');
        }
        ...
        $data = $this->getDataNeracaSaldo($bulan, $tahun, $userId);
        ...
        return view('neraca_saldo', compact(
    ...
    public function showNeracaSaldo(Request $request)
{
    ...
    return view('neraca_saldo_main', compact('tahun', 'groupedJurnal', 'bulanList'));
}
