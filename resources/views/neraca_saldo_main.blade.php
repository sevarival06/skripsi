        ...
        <div class="col mb-5 mb-xl-0">
            <div class="card shadow">
                <div class="card-header border-0">
                    ...
                    <div class="row">
                        <div class="col my-3">
                            <form action="{{ route('neraca_saldo.detail') }}" method="GET" class="d-flex flex-row justify-content-center">
                            ...
                            @if(isset($groupedJurnal) && $groupedJurnal->count() > 0)
                                @foreach($groupedJurnal as $key => $group)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('neraca_saldo.detail') }}" method="GET">
                                                <input type="hidden" name="bulan" value="{{ $bulan }}">
                                                <input type="hidden" name="tahun" value="{{ $tahun }}">
                                                <button type="submit" class="btn btn-success mr-3">Lihat Neraca Saldo</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
