                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ date('d F Y', strtotime($row->tgl_ekuitas)) }}</td>
                            ...
                            <!-- <a href="{{ route('ekuitas.edit', $row->id_ekuitas) }}" class="btn btn-sm btn-primary">Edit</a> -->
                            <form action="{{ route('ekuitas.destroy', $row->id_ekuitas) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                            ...
                            @else
                            <tr>
                                <td colspan="6" class="text-center">Tidak ada data ekuitas</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
