                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ date('d F Y', strtotime($row->tgl_liabilitas)) }}</td>
                            ...
                            <!-- <a href="{{ route('liabilitas.edit', $row->id_liabilitas) }}" class="btn btn-sm btn-primary">Edit</a> -->
                            <form action="{{ route('liabilitas.destroy', $row->id_liabilitas) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
                            ...
                            @else
                            <tr>
                                <td colspan="6" class="text-center">Tidak ada data Liabilitas</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
