                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ date('d F Y', strtotime($row->tgl_beban)) }}</td>
                                ...
                                <td class="text-center">
                                    <!-- <a href="{{ route('beban.edit', $row->id_beban) }}" class="btn btn-sm btn-primary">Edit</a> -->
                                    <form action="{{ route('beban.destroy', $row->id_beban) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                            ...
                            @else
                            <tr>
                                <td colspan="6" class="text-center">Tidak ada data Beban</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
