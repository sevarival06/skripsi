            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <p>
                                Pada formulir di bawah ini, Anda dapat menambah saldo dengan memilih jenis saldo <b>Debit</b> 
                                dan jika ingin mengurangi saldo Anda bisa memilih jenis saldo <b>Kredit</b>.
                            </p>
                        ...
                        <!-- Tanggal -->
                        <div class="form-group mb-3">
                            <label for="tgl_beban" class="form-control-label">Tanggal</label>
                            <div class="input-group">
                                <input type="date" class="form-control @error('tgl_beban') is-invalid @enderror" 
                                       id="tgl_beban" name="tgl_beban" 
                                       value="{{ old('tgl_beban', $data->tgl_beban ?? '') }}">
                                @error('tgl_beban')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
